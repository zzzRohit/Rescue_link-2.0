...
export const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-[1000] grid grid-cols-4 border-t border-slate-200 bg-white px-2 py-2 text-[11px] font-medium text-slate-500 sm:hidden">
