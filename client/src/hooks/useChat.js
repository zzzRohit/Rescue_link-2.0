...
const initialMessage = {
  role: "assistant",
  content:
    "Hi! Tell me about the animal you found and what's happening.\nI'll guide you on what to do safely right now.",
    ...
    async (content, imageUrls = []) => {
      ...
      try {
        const response = await fetch(
          `${import.meta.env.VITE_API_BASE_URL || "https://rescue-link-backend.onrender.com"}/api/chat`,
          {
            method: "POST",
