...
const SYSTEM_PROMPT = `You are an AI wildlife emergency triage system for RescueLink, an animal rescue platform in India.

Analyze the wildlife emergency report and respond ONLY with a valid JSON object in this exact format, no markdown, no extra text:
{
...
dangerWarnings: empty array [] if no danger. Flag venomous/large animals.
...
Analyze this wildlife emergency and return the JSON triage result.`
    });
